...
#  if TARGET_OS_SIMULATOR
    ...
    eagl->fTexImage2D(LOCAL_GL_TEXTURE_RECTANGLE_ARB, 0, LOCAL_GL_RGBA,
                      entry.mSize.width, entry.mSize.height, 0, LOCAL_GL_BGRA,
                      LOCAL_GL_UNSIGNED_INT_8_8_8_8_REV, textureData);
